...
use Elastic\Ogi\Traits\ClientEndpointsTrait;
use Elastic\Ogi\Traits\EndpointTrait;
use Elastic\Ogi\Traits\NamespaceTrait;
use Elastic\Ogi\Transport\AsyncOnSuccess;
use Elastic\Ogi\Transport\AsyncOnSuccessNoException;
...
final class Client implements ClientInterface
{
    ...
    /**
     * Set the default settings for Ogi
     */
